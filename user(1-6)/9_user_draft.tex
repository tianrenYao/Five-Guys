...
This document is intended to help end users understand how to access the platform, navigate between modules, and perform the main tasks available to them. It is not a system design document. Instead, it focuses on practical interaction from the user perspective, including common workflows such as logging in, entering sustainability records, generating reports, reviewing alerts, and using management pages. The user manual is task-oriented, role-sensitive, and based on the current implemented version of the system rather than early planning ideas.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{welcome_page.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{logged_in_page.png}
  \caption{login page with correct and error situation}
  \label{fig:logged_in_page}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{carbon_tracking.png}
  \caption{Carbon Footprint Tracking}
  \label{fig:carbon_tracking}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{carbon_comparison.png}
  \caption{Carbon Data comparison}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{waste_management.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{waste_comparison.png}
  \caption{Waste Data Comparison}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{reports_page.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{training_page.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{alert_page.png}
  \caption{Alert page}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{anomaly_detection.png}
